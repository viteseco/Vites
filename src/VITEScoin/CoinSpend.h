 ...
 * @file       CoinSpend.h
 *
 * @brief      CoinSpend class for the VITEScoin library.
 *
...
/** The complete proof needed to spend a VITEScoin.
...
public:
	...
	/**Generates a proof spending a VITEScoin.
	 *
	 * To use this, provide an unspent PrivateCoin, the latest Accumulator
	 * (e.g from the most recent vitescoin block) containing the public part
	 ...
	 * @param m arbitrary meta data related to the spend that might be needed by vitescoin
	 * 			(i.e. the transaction hash)
	 * @throw VITEScoinException if the process fails
	 */
