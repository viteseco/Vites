 ...
 * @file       Accumulator.h
 *
 * @brief      Accumulator and AccumulatorWitness classes for the VITEScoin library.
 *
...
public:
	 ...
	 * @throw      VITEScoin exception in case of invalid parameters
	 **/
	 ...
	 *
	 * @throw		VITEScoin exception if the coin is not valid.
	 *
	 **/
	...
	//  * @throw  A VITEScoinException if the accumulator value is invalid.
	//  */
