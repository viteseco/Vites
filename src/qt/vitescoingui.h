#ifndef VITESCOINGUI_H
#define VITESCOINGUI_H
...
/**
  vitescoin GUI main class. This class represents the main window of the vitescoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class vitescoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit vitescoinGUI(QWidget *parent = 0);
    ~vitescoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a vitescoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
