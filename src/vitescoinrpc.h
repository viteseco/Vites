...
#ifndef _VITESCOINRPC_H_
#define _VITESCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // vitescoin is not connected
...
/**
 * vitescoin RPC command dispatcher.
 */
class CRPCTable
{
private:
