...
#ifndef H_VITESCOIN_SCRIPT
#define H_VITESCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CvitescoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, vitescoin always counted CHECKMULTISIGs
